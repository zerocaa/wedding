...
const weddingSchema = new mongoose.Schema(
  {
    ...
    name: {
      type: String,
      required: [true, 'A Wedding must have a name'],
      unique: true,
      trim: true,
      maxlength: [
        40,
        'A Wedding name must have less or equal then 40 characters'
      ],
      minlength: [
        10,
        'A Wedding name must have more or equal then 10 characters'
      ]

...
export const eventUser = async (eventId,data) => {
  // const test = await axios(`https://wedding-production-052d.up.railway.app/api/v1/events/${eventId}`);
  // console.log(test);
...
export const deleteEvent = async courseId => {
  try {
      const res = await axios({
        ...
        // url: `https://wedding-production-052d.up.railway.app/api/v1/events/${courseId}`
      });
           if (res) {

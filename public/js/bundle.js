...
var showAlert = function showAlert(type, message) {
  ...
  if (type = "success") {
    var markup = "\n        <div class=\"alert alert-".concat(type, " rounded-0 mb-0 mt-1\">\n            <div class=\"container-md\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-12\">\n\t\t\t\t\t\t<p class=\"text-left mb-0\">\n                            <strong>\n                                ").concat(message, "\n                                <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button>\n                            </strong>\n                        </p>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n        </div>");
    document.querySelector('body').insertAdjacentHTML('afterbegin', markup);
    window.setTimeout(hideAlert, 20000);
  } else {
    var _markup = "<div class=\"alert alert-".concat(type, " rounded-0 mb-0 mt-1\">\n            <div class=\"container-md\">\n\t\t\t\t<div class=\"row\">\n\t\t\t\t\t<div class=\"col-12\">\n\t\t\t\t\t\t<p class=\"text-left mb-0\">\n                            <strong>\n                                ").concat(message, "\n                                <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\" aria-label=\"Close\"></button>\n                            </strong>\n                        </p>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n        </div>");

    document.querySelector('body').insertAdjacentHTML('afterbegin', _markup);
    window.setTimeout(hideAlert, 20000);
  }
};
...
var baseUrl = "https://wedding-production-09d7.up.railway.app";
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(baseUrl, "/api/v1/users/signup"),
              data: {
                name: name,
                email: email,
                password: password,
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(baseUrl, "/api/v1/users/forgotPassword"),
              data: {
                email: email
              }
            });
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "".concat(baseUrl, "/api/v1/users/resetPassword/").concat(token),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
...
var baseUrl = "https://wedding-production-09d7.up.railway.app"; //export const update DataUser
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === "password" ? "".concat(baseUrl, "/api/v1/users/updateMyPassword") : "".concat(baseUrl, "/api/v1/users/updateMe");
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"eventUpdate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.eventUser = exports.deleteEvent = exports.createEvent = void 0;
...
var eventUser = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.reload(true);
              (0, _alert.showAlert)('success', 'Update success');
            }
  ...
  return function eventUser(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var createEvent = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(wedding) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function createEvent(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
...
var deleteEvent = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(courseId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (res) {
              (0, _alert.showAlert)('success', 'Delete success');
              location.reload(true);
            }
  ...
  return function deleteEvent(_x4) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteEvent = deleteEvent;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"storyUpdate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateStory = exports.storyUser = exports.deleteStory = exports.createStory = void 0;
...
var updateStory = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PUT',
              url: "".concat(baseUrl, "/api/v1/storyloves/").concat(storyId),
              data: {
                title: title,
                time: time,
                content: content
  ...
  return function updateStory(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var storyUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(storyId, data) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function storyUser(_x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();

exports.storyUser = storyUser;

var createStory = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(wedding) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(baseUrl, "/api/v1/storyloves"),
              data: {
                wedding: wedding
              }
            });
  ...
  return function createStory(_x7) {
    return _ref3.apply(this, arguments);
  };
}();
...
var deleteStory = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(storyId) {
    var res;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
  ...
  return function deleteStory(_x8) {
    return _ref4.apply(this, arguments);
  };
}();

exports.deleteStory = deleteStory;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"createwedding.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteWedding = exports.createwedding = void 0;
...
var createwedding = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(baseUrl, "/api/v1/weddings"),
              data: data
            });
  ...
  return function createwedding(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteWedding = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "".concat(baseUrl, "/api/v1/weddings/").concat(id)
            });
  ...
  return function deleteWedding(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteWedding = deleteWedding;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"bridesMaidsUpdate.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateBridesMaids = exports.deleteBridesMaids = exports.createBridesMaids = void 0;
...
var createBridesMaids = /*#__PURE__*/function () {
  ...
  return function createBridesMaids(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.createBridesMaids = createBridesMaids;

var updateBridesMaids = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(bridesmaidId, data) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PUT',
              url: "".concat(baseUrl, "/api/v1/bridesmaids/").concat(bridesmaidId),
              data: data
            });
  ...
  return function updateBridesMaids(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();

exports.updateBridesMaids = updateBridesMaids;

var deleteBridesMaids = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(bridesmaidId) {
    var res;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
  ...
  return function deleteBridesMaids(_x4) {
    return _ref3.apply(this, arguments);
  };
}();

exports.deleteBridesMaids = deleteBridesMaids;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"contact.js":[function(require,module,exports) {
"use strict";
...
var createContact = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "".concat(baseUrl, "/api/v1/contact"),
              data: {
                name: name,
                email: email,
                content: content,
  ...
  return function createContact(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
...
var deleteContact = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "".concat(baseUrl, "/api/v1/contact/").concat(id)
            });
  ...
  return function deleteContact(_x5) {
    return _ref2.apply(this, arguments);
  };
}();

exports.deleteContact = deleteContact;
},{"./alert":"alert.js","axios":"../../node_modules/axios/index.js"}],"templatesEdit.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.templatesEdit = void 0;
...
var templatesEdit = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PUT',
              url: "".concat(baseUrl, "/api/v1/templates/").concat(templatesId),
              data: data
            });
  ...
  return function templatesEdit(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.templatesEdit = templatesEdit;
...
var _eventUpdate = require("./eventUpdate");

var _storyUpdate = require("./storyUpdate");

var _createwedding = require("./createwedding");

var _bridesMaidsUpdate = require("./bridesMaidsUpdate");

var _contact = require("./contact");

var _templatesEdit = require("./templatesEdit");
...
var createweddingForm = document.querySelector('.form-create-wedding');
var createContactForm = document.querySelector('.form-contact');
var tempaltesForm = document.querySelector('.form-templates');
var eventForm = document.querySelectorAll('.form-event-user');
var storyForm = document.querySelectorAll('.form-story-user');
var contact = document.querySelector('.send-button');
var bridesmaidsForm = document.querySelector('.form-bridesmaid-user');
var createEventForm = document.getElementById('add-more-event');
var createStoryForm = document.getElementById('add-more-story');
var createBridesMaidForm = document.getElementById('add-more-bridesmaids');
var test = document.querySelectorAll('.form-user-test');

if (tempaltesForm) {
  tempaltesForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var templatesId, mainPhoto, middlePhoto, titlePhoto, bottomPhoto, mainFormPhoto, middleFormPhoto, bottomFormPhoto, titleFormPhoto, form;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              templatesId = document.getElementById('templatesId').value;
              mainPhoto = document.getElementById('mainPhoto').files[0];
              middlePhoto = document.getElementById('middlePhoto').files[0];
              titlePhoto = document.getElementById('titlePhoto').files[0];
              bottomPhoto = document.getElementById('bottomPhoto').files[0];
              if (mainPhoto != undefined) mainFormPhoto = document.getElementById('mainPhoto').files[0];else mainFormPhoto = document.getElementById('mainPhotolock').value;
              if (middlePhoto != undefined) middleFormPhoto = document.getElementById('middlePhoto').files[0];else middleFormPhoto = document.getElementById('middlePhotolock').value;
              if (bottomPhoto != undefined) bottomFormPhoto = document.getElementById('bottomPhoto').files[0];else bottomFormPhoto = document.getElementById('bottomPhotolock').value;
              if (titlePhoto != undefined) titleFormPhoto = document.getElementById('titlePhoto').files[0];else titleFormPhoto = document.getElementById('titlePhotolock').value;
              form = new FormData();
              ...
              _context.next = 25;
              return (0, _templatesEdit.templatesEdit)(templatesId, form);
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 2:
              ...
              bridesmaidId = document.getElementById('bridesmaidId' + i).value;
              photo = document.getElementById('avatar' + i).files[0];
...
document.addEventListener('DOMContentLoaded', function () {
  var deleteBtn = $('.delete-wish');
  deleteBtn.click(function (e) {
    e.preventDefault();
    var contactId = $(this).data('id');
    (0, _contact.deleteContact)(contactId);
  });
}, true);
document.addEventListener('DOMContentLoaded', function () {
  var weddingId;
  ...
  deleteBtn.click(function (e) {
    ...
    (0, _createwedding.deleteWedding)(weddingId);
  });
}, true);
document.addEventListener('DOMContentLoaded', function () {
  var bridemaidId;
  ...
  deleteBtn.click(function (e) {
    ...
    (0, _bridesMaidsUpdate.deleteBridesMaids)(bridemaidId);
  });
}, true);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 2:
                ...
                story = document.getElementById('storyId' + i).value;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  deleteBtn.click(function (e) {
    ...
    (0, _storyUpdate.deleteStory)(storyId);
  });
});
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  deleteBtn.click(function (e) {
    ...
    (0, _eventUpdate.deleteEvent)(eventId);
  });
});
        ...
        while (1) {
          switch (_context9.prev = _context9.next) {
            ...
            case 2:
              ...
              event = document.getElementById('eventId' + i).value;
              photo = document.getElementById('eventPhoto' + i).files[0];
              console.log(photo);
              _test = document.getElementById('eventphotostore' + i).value;
              console.log(_test);
              ...
              _form.append('name', document.getElementById('name' + i).value);

              _form.append('date', document.getElementById('date' + i).value);

              _form.append('time', document.getElementById('time' + i).value);

              _form.append('address', document.getElementById('address' + i).value);

              _form.append('map', document.getElementById('map' + i).value);
            ...
            case 22:
              ...
              _form2.append('name', document.getElementById('name' + i).value);

              _form2.append('date', document.getElementById('date' + i).value);

              _form2.append('time', document.getElementById('time' + i).value);

              _form2.append('address', document.getElementById('address' + i).value);

              _form2.append('map', document.getElementById('map' + i).value);
        ...
        while (1) {
          switch (_context10.prev = _context10.next) {
            ...
            case 15:
              ...
              _form3.append('name', document.getElementById('name').value);

              _form3.append('email', document.getElementById('email').value);

              _form3.append('photo', document.getElementById('photo').files[0]);

              _form3.append('address', document.getElementById('address').value);

              _form3.append('phone', document.getElementById('phone').value);

...
var eventUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, eventId) {
    var event;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:3000/api/v1/event/".concat(eventId),
              data: data
            });

          case 3:
            event = _context.sent;
            console.log(event); //    if (res.data.status === 'success') {
            //      showAlert(
            //        'success',
...
var eventForm = document.querySelector('.form-event-user');

if (eventForm) {
  eventForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              console.log(eventId);
              _context.next = 5;
              return (0, _eventUpdate.eventUser)(eventId);
